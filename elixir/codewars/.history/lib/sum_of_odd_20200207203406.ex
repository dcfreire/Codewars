...
defmodule TestSolutions do
  ...
  test "Basic Tests" do
    ...
    assert SumOfOdd.row_sum_odd_numbers(74) == 405_224
    assert SumOfOdd.row_sum_odd_numbers(86) == 636_056
    assert SumOfOdd.row_sum_odd_numbers(93) == 804_357
    assert SumOfOdd.row_sum_odd_numbers(101) == 1_030_301
  end
